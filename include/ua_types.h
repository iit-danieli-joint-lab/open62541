...
struct UA_DataType {
    ...
    UA_Byte   typeKind    : 6; /* Dispatch index for the handling routines */
    UA_Byte   pointerFree : 1; /* The type (and its members) contains no
                                * pointers that need to be freed */
    UA_Byte overlayable   : 1; /* The type has the identical memory layout in
